                                    ...
                                    <div className="options">
                                        {
                                            current_user.isSeller && (
                                               ...
                                               {
                                                !current_user?.isSeller && (<> <Link className='link' key={505} to='/confirm'>New parposel</Link></>)
                                    
                                               }{
                                                !current_user?.isSeller && (<> <Link className='link' key={505} to='/project'>currrent Project</Link></>)
                                    
                                               }{
                                                current_user?.isSeller && (<> <Link className='link' key={505} to='/project'>currrent Project</Link></>)
                                    
                                               }{
                                                current_user?.isSeller && (<> <Link className='link' key={9996} to='/orders'>Orders</Link></>)
